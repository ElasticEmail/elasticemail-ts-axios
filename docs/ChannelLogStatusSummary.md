...
------------ | ------------- | ------------- | -------------
**ChannelName** | **string** | Channel name | [optional] [default to undefined]
...
```typescript
import { ChannelLogStatusSummary } from 'elasticemail-client-ts-axios';

const instance: ChannelLogStatusSummary = {
    ChannelName,
    Recipients,
    EmailTotal,
    SmsTotal,
