...
------------ | ------------- | ------------- | -------------
**MonthlyRefillCredits** | **number** | Amount of credits added to Account automatically | [optional] [default to undefined]
...
```typescript
import { SubaccountEmailSettings } from 'elasticemail-client-ts-axios';

const instance: SubaccountEmailSettings = {
