...
export const SegmentsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        segmentsByNameDelete: async (name: string, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        segmentsByNameGet: async (name: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        segmentsByNamePut: async (name: string, segmentPayload: SegmentPayload, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        segmentsGet: async (limit?: number, offset?: number, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        segmentsPost: async (segmentPayload: SegmentPayload, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'segmentPayload' is not null or undefined
...
export const SegmentsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async segmentsByNameDelete(name: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async segmentsByNameGet(name: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Segment>> {
         ...
         * @throws {RequiredError}
         */
        async segmentsByNamePut(name: string, segmentPayload: SegmentPayload, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Segment>> {
         ...
         * @throws {RequiredError}
         */
        async segmentsGet(limit?: number, offset?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Segment>>> {
         ...
         * @throws {RequiredError}
         */
        async segmentsPost(segmentPayload: SegmentPayload, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Segment>> {
...
export class SegmentsApi extends BaseAPI implements SegmentsApiInterface {
     ...
     */
    public segmentsByNameDelete(name: string, options?: any) {
     ...
     * @memberof SegmentsApi
     */
    public segmentsByNameGet(name: string, options?: any) {
     ...
     * @memberof SegmentsApi
     */
    public segmentsByNamePut(name: string, segmentPayload: SegmentPayload, options?: any) {
     ...
     * @memberof SegmentsApi
     */
    public segmentsGet(limit?: number, offset?: number, options?: any) {
     ...
     * @memberof SegmentsApi
     */
    public segmentsPost(segmentPayload: SegmentPayload, options?: any) {
